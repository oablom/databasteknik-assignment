...
// 	try {
const connected = await connect("mongodb://localhost:27017/OaBlomAssignment1");
...
const movieDataLibrary = mongoose.model(
	"movieLibrary",
	movieLibrarySchema,
	"movieLibrary"
);

console.log(movieDataLibrary);
...
// database();
export default movieDataLibrary;
